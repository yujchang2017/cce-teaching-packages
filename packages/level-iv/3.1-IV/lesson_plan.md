...
## 第 2 節（45 分）｜解構：脆弱度三因素與系統

**目標**：C1 C2 全達、S1、B1

| 時間 | 活動 | 資源 |
|---|---|---|
| 0–8 | **三因素工作坊**：先用白話拆解「危險在哪裡、誰比較容易受傷、誰有資源恢復」，再補充脆弱度 V = 暴露 × 敏感度 ÷ 調適力（引 MOE RAG 0089）；學生只需用高／中／低判斷，不要求計算 | 情境卡×8 |
| 8–25 | **SAVIOURS 桌遊／替代版**：各組扮演不同收入家庭，面對颱風事件，看誰最先破產或失家 | map.csv #237 |
| 25–38 | **惡性循環排序**：先用四張卡排出「貧窮 → 調適能力低 → 災損更大 → 更難恢復」，教師再說明這就是簡化版因果迴路圖 (CLD)；進階組可加 1 個介入點 | 大海報、排序卡 |
| 38–45 | 形成性評量 3：各組用一句話解釋一個節點，並提出一個可打斷循環的支持方式 | Rubric |
...
| 20–35 | **COP 微型會議（簡化版）**：學生扮演臺灣、吐瓦魯、美國、印度、原住民代表，先用句型「誰造成較多？誰受害較深？誰最需要幫助？」討論，再補充「損失與損害基金」概念——引 MOE RAG 0164 | 角色立場卡、句型卡 |
...
| 10–30 | **專題工作坊**：各組從以下選一主題，產出 1 份「公正氣候行動計畫」。一般組完成「對象、問題、3 行動、第一步、成效檢查」即可；進階組再加利害關係人地圖、時間軸、風險評估。<br>(1) 校園偏熱教室降溫補助（年齡脆弱）<br>(2) 社區獨居長者熱浪關懷系統<br>(3) 學生參與校務基金氣候支出（學生治理）<br>(4) 臺灣企業供應鏈對 LDC 影響倡議 | 工作單 |
